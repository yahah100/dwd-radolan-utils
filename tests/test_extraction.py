...
class TestExtractTimeSeriesFromRadar:
    ...
    def test_extract_time_series_basic(self, mock_cut, mock_read, sample_boolean_grid, 
                                     sample_radar_data, sample_time_data, temp_directory):
    ...
    def test_extract_time_series_with_save(self, mock_save, mock_cut, mock_read, 
                                         sample_boolean_grid, sample_radar_data, 
                                         sample_time_data, temp_directory):
